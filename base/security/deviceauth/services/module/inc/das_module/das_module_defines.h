...
typedef enum CurTaskTypeT {
    ...
    TASK_TYPE_PAKE_PROTOCOL = 1,
    TASK_TYPE_NEW_PAKE_PROTOCOL = 2,
    TASK_TYPE_BIND_LITE_EXCHANGE,
    TASK_TYPE_UNBIND_LITE_EXCHANGE,
    TASK_TYPE_BIND_STANDARD_EXCHANGE,
    TASK_TYPE_UNBIND_STANDARD_EXCHANGE,
    TASK_TYPE_NONE,
} CurTaskType;
