...
/**
 * @brief Writes data to an I2C device, and Reads data from the I2C device.
 *
 *
 *
 * @param id Indicates the I2C device ID.
 * @param deviceAddr Indicates the I2C device address.
 * @param writeData Indicates the pointer to the data to write.
 * @param writeDataLen Indicates the length of the data to write.
 * @param readData Indicates the pointer to the data to read.
 * @param readDataLen Indicates the length of the data to read.
 * @return Returns {@link IOT_SUCCESS} if the data is written to the I2C device successfully;
 * returns {@link IOT_FAILURE} otherwise. For details about other return values, see the chip description.
 * @since 2.2
 * @version 2.2
 */
unsigned int IoTI2cWriteRead(unsigned int id, unsigned short deviceAddr, const unsigned char *writeData, unsigned int writeDataLen, unsigned char *readData, unsigned int readDataLen);
